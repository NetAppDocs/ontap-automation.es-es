...
NOTE: La funcionalidad de control de acceso basado en roles de ONTAP ha seguido expandiéndose y se mejoró significativamente con ONTAP 9.11.1 (y versiones posteriores). Consulte link:../rest/rbac_overview.html#summary-of-rbac-evolution["Resumen de la evolución de RBAC"] y.. link:../whats_new.html["Novedades de la API DE REST de ONTAP y la automatización"] si quiere más información.
