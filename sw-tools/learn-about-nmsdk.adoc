...
NOTE: Si bien NetApp Manageability SDK y OnCommand Workflow Automation siguen recibiendo soporte, la API REST de ONTAP es la tecnología preferida y estratégica para usar al automatizar sus sistemas ONTAP . Ver link:../migrate/migration-considerations.html["Migre desde ONTAPI a la API de REST"] Para más información.
