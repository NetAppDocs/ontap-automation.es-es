...
Seguridad:: Se ha añadido una nueva función `whoami` para recuperar el nombre de usuario, el rol y la información de permisos del usuario conectado. También se ha mejorado la capacidad de autenticación web (WebAuthn).
