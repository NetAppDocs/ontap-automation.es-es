...
ONTAP 9.15.1 sigue ampliando las funcionalidades de la API de REST DE ONTAP. La actualización de esta versión es relativamente modesta, con tres nuevos puntos finales que admiten una nueva función.
