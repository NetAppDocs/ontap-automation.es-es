...
NOTE: En las versiones de ONTAP anteriores a la 9.9.1, puedes automatizar la administración de los permisos SACL y DACL usando la función de passthrough de la CLI. Consulta link:../migrate/migration-considerations.html["Consideraciones sobre migración"] para más información.
